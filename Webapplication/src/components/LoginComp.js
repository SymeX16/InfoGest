...
export default function LoginComp({setEnde, userId, userNick, buttonhandlerRegister}) {
    ...
    document.addEventListener("keydown", e => {
        if (e.key === "Enter") {
            if (document.getElementById("home_loginButton") == null) {
                ...
                document.getElementById("home_loginButton").click();
        }
    });
    ...
    return (
        <div className="loginMain">
            ...
            <button className="homeLoginButton" id="home_loginButton" onClick={login}>Login</button>

            <div className="buttonbar">
                <div>
                    <label className="homeRegisterLabel">No Login?</label>
                    <button className="homeRegisterButton" onClick={buttonhandlerRegister}>Register</button>
                </div>
            </div>
        </div>
    )
